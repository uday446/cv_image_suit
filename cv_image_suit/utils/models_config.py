...
class modellconfig:
    ...
    def return_model(self):
        if self.model_name == 'Xception':
            ...
            core_model = Xception(include_top=False,weights="imagenet",input_shape=(224, 224, 3))
            ...
            core_model = NASNetLarge(include_top=False,weights="imagenet",input_shape=(224, 224, 3))
            ...
            core_model = EfficientNetB3(include_top=False, weights="imagenet", input_shape=(224, 224, 3))

        elif self.model_name == 'EfficientNetB4':
            print("Loading EfficientNetB4..")
            core_model = EfficientNetB4(include_top=False, weights="imagenet", input_shape=(224, 224, 3))

        elif self.model_name == 'EfficientNetB5':
            print("Loading EfficientNetB5..")
            core_model = EfficientNetB5(include_top=False, weights="imagenet", input_shape=(224, 224, 3))

        elif self.model_name == 'EfficientNetB6':
            print("Loading EfficientNetB6..")
            core_model = EfficientNetB6(include_top=False, weights="imagenet", input_shape=(224, 224, 3))

        elif self.model_name == 'EfficientNetB7':
            print("Loading EfficientNetB7..")
            core_model = EfficientNetB7(include_top=False, weights="imagenet", input_shape=(224, 224, 3))
